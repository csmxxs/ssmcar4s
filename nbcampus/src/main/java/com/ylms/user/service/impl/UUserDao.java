package com.ylms.user.service.impl;
...
import com.ylms.common.dao.UUserMapper;
import com.ylms.common.dao.UUserRoleMapper;
import com.ylms.common.entity.UUser;
import com.ylms.common.entity.UUserRole;
...
import com.ylms.core.shiro.session.CustomSessionManager;
import com.ylms.core.shiro.token.manager.TokenManager;
import com.ylms.permission.bo.URoleBo;
import com.ylms.permission.bo.UserRoleAllocationBo;
import com.ylms.user.service.IUUserDao;

@Service
public class UUserDao extends BaseMybatisDao<UUserMapper> implements IUUserDao {
	/***
	 * 用户手动操作Session
	 * */
	@Autowired
	...
	public Pagination<UUser> findByPage(Map<String, Object> resultMap,
		 ...
		 //return page(resultMap, pageNo, pageSize);
	}
