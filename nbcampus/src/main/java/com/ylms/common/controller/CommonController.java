package com.ylms.common.controller;
...
import com.ylms.common.utils.vcode.Captcha;
import com.ylms.common.utils.vcode.GifCaptcha;
import com.ylms.common.utils.vcode.SpecCaptcha;
...
public class CommonController extends BaseController {
	...
	public ModelAndView _404(HttpServletRequest request){
		return new ModelAndView("common/404","message","找不到文件....");
	}
	/**
	 * 500错误
	 * @param request
	...
	public ModelAndView kickedOut(HttpServletRequest request,UrlPathHelper pp){
		//如果是踢出后，来源地址是：http://127.0.0.1:8080/nbcampus/u/login.shtml;JSESSIONID=4f1538d9-df19-48c8-b4b1-aadacadde23a
