...
public class ImgTools {
     ...
     * @throws IOException
     */
    public static boolean thumbnail_w_h(File img, int width, int height,
     ...
     * @throws IOException
     */
    public static boolean thumbnail(File img, int width, int height,
            OutputStream out) throws IOException {
        BufferedImage BI = ImageIO.read(img);
    ...
    public static void main(String[] args) throws IOException {
      /*  File img = new File("d:\\test.jpg");
        FileOutputStream fos = new FileOutputStream("d:\\b.jpg");
         if(ImgTools.thumbnail(img, 600, 900, fos)){
