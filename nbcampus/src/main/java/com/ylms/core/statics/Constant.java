package com.ylms.core.statics;

import java.util.Calendar;

import com.ylms.core.config.IConfig;
...
public interface Constant {
	...
	static final String DOMAIN_CDN = IConfig.get("domain.21cn");//静态资源域名
	static String VERSION = String.valueOf(System.currentTimeMillis());//版本号，重启的时间
	
	
	//存储到缓存，标识用户的禁止状态，解决在线用户踢出的问题
	final static String  EXECUTE_CHANGE_USER = "YLMS_EXECUTE_CHANGE_USER";
}
