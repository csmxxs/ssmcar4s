package com.ylms.core.shiro.token.manager;
...
import com.ylms.core.shiro.token.SampleRealm;
import com.ylms.core.shiro.token.ShiroToken;
...
public class TokenManager {
	...
	/**
	 * 清空当前用户权限信息。
	 * 目的：为了在判断权限的时候，再次会 <code>doGetAuthorizationInfo(...)  </code>方法。
